...
import com.framasaas.service.ServiceOrderQueryService;
...
/**
 * REST controller for managing {@link com.framasaas.domain.ServiceOrder}.
 */
@RestController
...
public class ServiceOrderResource {
    ...
    public ResponseEntity<ServiceOrderDTO> createServiceOrder(@Valid @RequestBody ServiceOrderDTO serviceOrderDTO)
        ...
        return ResponseEntity.created(new URI("/api/service-orders/" + serviceOrderDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, serviceOrderDTO.getId().toString()))
    ...
    public ResponseEntity<ServiceOrderDTO> partialUpdateServiceOrder(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, serviceOrderDTO.getId().toString())
        );
    }
