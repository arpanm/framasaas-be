...
public class Inventory implements Serializable {
    ...
    public Inventory inventoryValue(Long inventoryValue) {
    ...
    public Inventory isSellable(Boolean isSellable) {
    ...
    public Inventory createddBy(String createddBy) {
    ...
    public Inventory createdTime(Instant createdTime) {
    ...
    public Inventory updatedBy(String updatedBy) {
    ...
    public Inventory updatedTime(Instant updatedTime) {
    ...
    public void setAdditionalAttributes(Set<AdditionalAttribute> additionalAttributes) {
        if (this.additionalAttributes != null) {
            this.additionalAttributes.forEach(i -> i.setInventory(null));
        }
        if (additionalAttributes != null) {
            additionalAttributes.forEach(i -> i.setInventory(this));
        }
        this.additionalAttributes = additionalAttributes;
    }

    public Inventory additionalAttributes(Set<AdditionalAttribute> additionalAttributes) {
        this.setAdditionalAttributes(additionalAttributes);
        return this;
    }

    public Inventory addAdditionalAttribute(AdditionalAttribute additionalAttribute) {
        this.additionalAttributes.add(additionalAttribute);
        additionalAttribute.setInventory(this);
        return this;
    }

    public Inventory removeAdditionalAttribute(AdditionalAttribute additionalAttribute) {
        this.additionalAttributes.remove(additionalAttribute);
        additionalAttribute.setInventory(null);
        return this;
    }
    ...
    public Inventory location(InventoryLocation inventoryLocation) {
