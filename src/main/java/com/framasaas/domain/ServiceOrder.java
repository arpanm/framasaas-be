...
public class ServiceOrder implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JsonIgnoreProperties(value = { "serviceOrders", "product" }, allowSetters = true)
    private ServiceOrderMaster serviceMaster;
    ...
    public ServiceOrderMaster getServiceMaster() {
        return this.serviceMaster;
    }

    public void setServiceMaster(ServiceOrderMaster serviceOrderMaster) {
        this.serviceMaster = serviceOrderMaster;
    }

    public ServiceOrder serviceMaster(ServiceOrderMaster serviceOrderMaster) {
        this.setServiceMaster(serviceOrderMaster);
        return this;
    }
