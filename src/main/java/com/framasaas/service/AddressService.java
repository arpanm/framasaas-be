...
/**
 * Service Interface for managing {@link com.framasaas.domain.Address}.
 */
public interface AddressService {
    ...
    /**
     * Get all the AddressDTO where Franchise is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<AddressDTO> findAllWhereFranchiseIsNull();
