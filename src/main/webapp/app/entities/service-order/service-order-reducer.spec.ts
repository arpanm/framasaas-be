...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEORDER actions', async () => {
      const arg = { id: 32224 };
    ...
    it('dispatches UPDATE_SERVICEORDER actions', async () => {
      const arg = { id: 32224 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEORDER actions', async () => {
      const arg = 42666;
