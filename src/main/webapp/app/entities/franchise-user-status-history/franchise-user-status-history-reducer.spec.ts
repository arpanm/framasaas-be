...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-user-status-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISEUSERSTATUSHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISEUSERSTATUSHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISEUSERSTATUSHISTORY actions', async () => {
      const arg = { id: 15496 };
    ...
    it('dispatches UPDATE_FRANCHISEUSERSTATUSHISTORY actions', async () => {
      const arg = { id: 15496 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISEUSERSTATUSHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISEUSERSTATUSHISTORY actions', async () => {
      const arg = 42666;
