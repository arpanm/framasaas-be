...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-category-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISECATEGORYMAPPING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISECATEGORYMAPPING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISECATEGORYMAPPING actions', async () => {
      const arg = { id: 20651 };
    ...
    it('dispatches UPDATE_FRANCHISECATEGORYMAPPING actions', async () => {
      const arg = { id: 20651 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISECATEGORYMAPPING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISECATEGORYMAPPING actions', async () => {
      const arg = 42666;
