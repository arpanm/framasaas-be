...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-allocation-rule-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISEALLOCATIONRULESET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISEALLOCATIONRULESET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISEALLOCATIONRULESET actions', async () => {
      const arg = { id: 4687 };
    ...
    it('dispatches UPDATE_FRANCHISEALLOCATIONRULESET actions', async () => {
      const arg = { id: 4687 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISEALLOCATIONRULESET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISEALLOCATIONRULESET actions', async () => {
      const arg = 42666;
