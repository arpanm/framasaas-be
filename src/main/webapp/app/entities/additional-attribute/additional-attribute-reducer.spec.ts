...
import reducer, {
  ...
  reset,
  updateEntity,
} from './additional-attribute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADDITIONALATTRIBUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADDITIONALATTRIBUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADDITIONALATTRIBUTE actions', async () => {
      const arg = { id: 1616 };
    ...
    it('dispatches UPDATE_ADDITIONALATTRIBUTE actions', async () => {
      const arg = { id: 1616 };
    ...
    it('dispatches PARTIAL_UPDATE_ADDITIONALATTRIBUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADDITIONALATTRIBUTE actions', async () => {
      const arg = 42666;
