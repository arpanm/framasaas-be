...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISEDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISEDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISEDOCUMENT actions', async () => {
      const arg = { id: 14340 };
    ...
    it('dispatches UPDATE_FRANCHISEDOCUMENT actions', async () => {
      const arg = { id: 14340 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISEDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISEDOCUMENT actions', async () => {
      const arg = 42666;
