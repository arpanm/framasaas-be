...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './hsn.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HSN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HSN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HSN actions', async () => {
      const arg = { id: 13910 };
    ...
    it('dispatches UPDATE_HSN actions', async () => {
      const arg = { id: 13910 };
    ...
    it('dispatches PARTIAL_UPDATE_HSN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HSN actions', async () => {
      const arg = 42666;
