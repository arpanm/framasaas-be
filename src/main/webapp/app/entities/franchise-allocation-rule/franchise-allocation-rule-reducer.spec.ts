...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-allocation-rule.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISEALLOCATIONRULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISEALLOCATIONRULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISEALLOCATIONRULE actions', async () => {
      const arg = { id: 30551 };
    ...
    it('dispatches UPDATE_FRANCHISEALLOCATIONRULE actions', async () => {
      const arg = { id: 30551 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISEALLOCATIONRULE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISEALLOCATIONRULE actions', async () => {
      const arg = 42666;
