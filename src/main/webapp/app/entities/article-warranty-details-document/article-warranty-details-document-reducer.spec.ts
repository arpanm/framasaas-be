...
import reducer, {
  ...
  reset,
  updateEntity,
} from './article-warranty-details-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTICLEWARRANTYDETAILSDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTICLEWARRANTYDETAILSDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTICLEWARRANTYDETAILSDOCUMENT actions', async () => {
      const arg = { id: 16641 };
    ...
    it('dispatches UPDATE_ARTICLEWARRANTYDETAILSDOCUMENT actions', async () => {
      const arg = { id: 16641 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTICLEWARRANTYDETAILSDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTICLEWARRANTYDETAILSDOCUMENT actions', async () => {
      const arg = 42666;
