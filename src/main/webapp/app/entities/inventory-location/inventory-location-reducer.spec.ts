...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inventory-location.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTORYLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVENTORYLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVENTORYLOCATION actions', async () => {
      const arg = { id: 4470 };
    ...
    it('dispatches UPDATE_INVENTORYLOCATION actions', async () => {
      const arg = { id: 4470 };
    ...
    it('dispatches PARTIAL_UPDATE_INVENTORYLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVENTORYLOCATION actions', async () => {
      const arg = 42666;
