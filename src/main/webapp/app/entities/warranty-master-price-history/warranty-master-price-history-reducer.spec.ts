...
import reducer, {
  ...
  reset,
  updateEntity,
} from './warranty-master-price-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WARRANTYMASTERPRICEHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WARRANTYMASTERPRICEHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WARRANTYMASTERPRICEHISTORY actions', async () => {
      const arg = { id: 31972 };
    ...
    it('dispatches UPDATE_WARRANTYMASTERPRICEHISTORY actions', async () => {
      const arg = { id: 31972 };
    ...
    it('dispatches PARTIAL_UPDATE_WARRANTYMASTERPRICEHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WARRANTYMASTERPRICEHISTORY actions', async () => {
      const arg = 42666;
