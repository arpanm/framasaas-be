...
import reducer, {
  ...
  reset,
  updateEntity,
} from './supporting-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPORTINGDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPORTINGDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPORTINGDOCUMENT actions', async () => {
      const arg = { id: 6840 };
    ...
    it('dispatches UPDATE_SUPPORTINGDOCUMENT actions', async () => {
      const arg = { id: 6840 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPORTINGDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPORTINGDOCUMENT actions', async () => {
      const arg = 42666;
