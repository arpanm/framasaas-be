...
import reducer, {
  ...
  reset,
  updateEntity,
} from './additional-attribute-possible-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADDITIONALATTRIBUTEPOSSIBLEVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADDITIONALATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADDITIONALATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const arg = { id: 2469 };
    ...
    it('dispatches UPDATE_ADDITIONALATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const arg = { id: 2469 };
    ...
    it('dispatches PARTIAL_UPDATE_ADDITIONALATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADDITIONALATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const arg = 42666;
