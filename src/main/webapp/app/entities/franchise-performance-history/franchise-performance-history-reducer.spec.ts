...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-performance-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISEPERFORMANCEHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISEPERFORMANCEHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISEPERFORMANCEHISTORY actions', async () => {
      const arg = { id: 6073 };
    ...
    it('dispatches UPDATE_FRANCHISEPERFORMANCEHISTORY actions', async () => {
      const arg = { id: 6073 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISEPERFORMANCEHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISEPERFORMANCEHISTORY actions', async () => {
      const arg = 42666;
