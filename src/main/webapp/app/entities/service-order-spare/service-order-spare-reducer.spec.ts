...
import reducer, {
  ...
  reset,
  updateEntity,
} from './service-order-spare.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEORDERSPARE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEORDERSPARE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEORDERSPARE actions', async () => {
      const arg = { id: 3630 };
    ...
    it('dispatches UPDATE_SERVICEORDERSPARE actions', async () => {
      const arg = { id: 3630 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEORDERSPARE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEORDERSPARE actions', async () => {
      const arg = 42666;
