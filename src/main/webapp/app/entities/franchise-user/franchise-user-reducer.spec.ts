...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISEUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISEUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISEUSER actions', async () => {
      const arg = { id: 20383 };
    ...
    it('dispatches UPDATE_FRANCHISEUSER actions', async () => {
      const arg = { id: 20383 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISEUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISEUSER actions', async () => {
      const arg = 42666;
