...
import reducer, {
  ...
  reset,
  updateEntity,
} from './service-order-field-agent-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEORDERFIELDAGENTASSIGNMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEORDERFIELDAGENTASSIGNMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEORDERFIELDAGENTASSIGNMENT actions', async () => {
      const arg = { id: 2944 };
    ...
    it('dispatches UPDATE_SERVICEORDERFIELDAGENTASSIGNMENT actions', async () => {
      const arg = { id: 2944 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEORDERFIELDAGENTASSIGNMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEORDERFIELDAGENTASSIGNMENT actions', async () => {
      const arg = 42666;
