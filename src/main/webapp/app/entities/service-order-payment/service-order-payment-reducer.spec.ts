...
import reducer, {
  ...
  reset,
  updateEntity,
} from './service-order-payment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEORDERPAYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEORDERPAYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEORDERPAYMENT actions', async () => {
      const arg = { id: 13973 };
    ...
    it('dispatches UPDATE_SERVICEORDERPAYMENT actions', async () => {
      const arg = { id: 13973 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEORDERPAYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEORDERPAYMENT actions', async () => {
      const arg = 42666;
