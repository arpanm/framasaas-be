...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-status-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISESTATUSHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISESTATUSHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISESTATUSHISTORY actions', async () => {
      const arg = { id: 8192 };
    ...
    it('dispatches UPDATE_FRANCHISESTATUSHISTORY actions', async () => {
      const arg = { id: 8192 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISESTATUSHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISESTATUSHISTORY actions', async () => {
      const arg = 42666;
