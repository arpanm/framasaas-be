...
import reducer, {
  ...
  reset,
  updateEntity,
} from './franchise-brand-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISEBRANDMAPPING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRANCHISEBRANDMAPPING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRANCHISEBRANDMAPPING actions', async () => {
      const arg = { id: 2950 };
    ...
    it('dispatches UPDATE_FRANCHISEBRANDMAPPING actions', async () => {
      const arg = { id: 2950 };
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISEBRANDMAPPING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRANCHISEBRANDMAPPING actions', async () => {
      const arg = 42666;
