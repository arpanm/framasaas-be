...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './pincode.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PINCODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PINCODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PINCODE actions', async () => {
      const arg = { id: 20654 };
    ...
    it('dispatches UPDATE_PINCODE actions', async () => {
      const arg = { id: 20654 };
    ...
    it('dispatches PARTIAL_UPDATE_PINCODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PINCODE actions', async () => {
      const arg = 42666;
