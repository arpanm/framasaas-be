...
import reducer, {
  ...
  reset,
  updateEntity,
} from './field-agent-skill-rule.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDAGENTSKILLRULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIELDAGENTSKILLRULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIELDAGENTSKILLRULE actions', async () => {
      const arg = { id: 29349 };
    ...
    it('dispatches UPDATE_FIELDAGENTSKILLRULE actions', async () => {
      const arg = { id: 29349 };
    ...
    it('dispatches PARTIAL_UPDATE_FIELDAGENTSKILLRULE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIELDAGENTSKILLRULE actions', async () => {
      const arg = 42666;
