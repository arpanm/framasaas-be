...
import reducer, {
  ...
  reset,
  updateEntity,
} from './field-agent-skill-rule-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDAGENTSKILLRULESET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIELDAGENTSKILLRULESET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIELDAGENTSKILLRULESET actions', async () => {
      const arg = { id: 6982 };
    ...
    it('dispatches UPDATE_FIELDAGENTSKILLRULESET actions', async () => {
      const arg = { id: 6982 };
    ...
    it('dispatches PARTIAL_UPDATE_FIELDAGENTSKILLRULESET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIELDAGENTSKILLRULESET actions', async () => {
      const arg = 42666;
