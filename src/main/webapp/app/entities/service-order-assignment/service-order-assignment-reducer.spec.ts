...
import reducer, {
  ...
  reset,
  updateEntity,
} from './service-order-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEORDERASSIGNMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEORDERASSIGNMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEORDERASSIGNMENT actions', async () => {
      const arg = { id: 4171 };
    ...
    it('dispatches UPDATE_SERVICEORDERASSIGNMENT actions', async () => {
      const arg = { id: 4171 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEORDERASSIGNMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEORDERASSIGNMENT actions', async () => {
      const arg = 42666;
