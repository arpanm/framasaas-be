...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WARRANTYMASTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WARRANTYMASTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WARRANTYMASTER actions', async () => {
      const arg = { id: 24890 };
    ...
    it('dispatches UPDATE_WARRANTYMASTER actions', async () => {
      const arg = { id: 24890 };
    ...
    it('dispatches PARTIAL_UPDATE_WARRANTYMASTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WARRANTYMASTER actions', async () => {
      const arg = 42666;
