...
import { deleteEntity, getEntity } from './article.reducer';
...
export const ArticleDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="framasaasApp.article.delete.question">
        <Translate contentKey="framasaasApp.article.delete.question" interpolate={{ id: articleEntity.id }}>
