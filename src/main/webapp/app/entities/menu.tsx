...
const EntitiesMenu = () => {
  return (
    <>
      ...
      <MenuItem icon="asterisk" to="/article-warranty-details">
        <Translate contentKey="global.menu.entities.articleWarrantyDetails" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/warranty-master">
        <Translate contentKey="global.menu.entities.warrantyMaster" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/warranty-master-price-history">
        <Translate contentKey="global.menu.entities.warrantyMasterPriceHistory" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/article-warranty-details-document">
        <Translate contentKey="global.menu.entities.articleWarrantyDetailsDocument" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/service-order-master">
        <Translate contentKey="global.menu.entities.serviceOrderMaster" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/service-order">
        <Translate contentKey="global.menu.entities.serviceOrder" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/service-order-payment">
        <Translate contentKey="global.menu.entities.serviceOrderPayment" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/service-order-assignment">
        <Translate contentKey="global.menu.entities.serviceOrderAssignment" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/service-order-franchise-assignment">
        <Translate contentKey="global.menu.entities.serviceOrderFranchiseAssignment" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/service-order-spare">
        <Translate contentKey="global.menu.entities.serviceOrderSpare" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/language-mapping">
        <Translate contentKey="global.menu.entities.languageMapping" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/field-agent-skill-rule-set">
        <Translate contentKey="global.menu.entities.fieldAgentSkillRuleSet" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/field-agent-skill-rule">
        <Translate contentKey="global.menu.entities.fieldAgentSkillRule" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/service-order-field-agent-assignment">
        <Translate contentKey="global.menu.entities.serviceOrderFieldAgentAssignment" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/inventory-location">
        <Translate contentKey="global.menu.entities.inventoryLocation" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/inventory">
        <Translate contentKey="global.menu.entities.inventory" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/inventory-history">
        <Translate contentKey="global.menu.entities.inventoryHistory" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/supporting-document">
        <Translate contentKey="global.menu.entities.supportingDocument" />
      </MenuItem>
