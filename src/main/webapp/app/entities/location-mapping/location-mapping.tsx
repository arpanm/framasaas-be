  ...
  return (
    <div>
      <h2 id="location-mapping-heading" data-cy="LocationMappingHeading">
        <Translate contentKey="framasaasApp.locationMapping.home.title">Location Mappings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="framasaasApp.locationMapping.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/location-mapping/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="framasaasApp.locationMapping.home.createLabel">Create new Location Mapping</Translate>
          </Link>
        </div>
      </h2>
          ...
          {locationMappingList && locationMappingList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="framasaasApp.locationMapping.id">ID</Translate>{' '}
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="framasaasApp.locationMapping.home.notFound">No Location Mappings found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
