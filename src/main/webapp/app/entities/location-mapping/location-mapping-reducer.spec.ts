...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIONMAPPING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCATIONMAPPING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCATIONMAPPING actions', async () => {
      const arg = { id: 18148 };
    ...
    it('dispatches UPDATE_LOCATIONMAPPING actions', async () => {
      const arg = { id: 18148 };
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIONMAPPING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOCATIONMAPPING actions', async () => {
      const arg = 42666;
