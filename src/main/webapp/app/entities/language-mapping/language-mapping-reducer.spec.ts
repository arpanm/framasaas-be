...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANGUAGEMAPPING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LANGUAGEMAPPING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LANGUAGEMAPPING actions', async () => {
      const arg = { id: 19274 };
    ...
    it('dispatches UPDATE_LANGUAGEMAPPING actions', async () => {
      const arg = { id: 19274 };
    ...
    it('dispatches PARTIAL_UPDATE_LANGUAGEMAPPING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LANGUAGEMAPPING actions', async () => {
      const arg = 42666;
