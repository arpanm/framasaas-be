...
import reducer, {
  ...
  reset,
  updateEntity,
} from './service-order-master.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEORDERMASTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEORDERMASTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEORDERMASTER actions', async () => {
      const arg = { id: 21265 };
    ...
    it('dispatches UPDATE_SERVICEORDERMASTER actions', async () => {
      const arg = { id: 21265 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEORDERMASTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEORDERMASTER actions', async () => {
      const arg = 42666;
