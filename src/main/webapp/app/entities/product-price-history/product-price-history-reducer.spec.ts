...
import reducer, {
  ...
  reset,
  updateEntity,
} from './product-price-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTPRICEHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTPRICEHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTPRICEHISTORY actions', async () => {
      const arg = { id: 25648 };
    ...
    it('dispatches UPDATE_PRODUCTPRICEHISTORY actions', async () => {
      const arg = { id: 25648 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTPRICEHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTPRICEHISTORY actions', async () => {
      const arg = 42666;
