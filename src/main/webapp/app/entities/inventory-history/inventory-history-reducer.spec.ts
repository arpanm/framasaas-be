...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inventory-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTORYHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVENTORYHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVENTORYHISTORY actions', async () => {
      const arg = { id: 4261 };
    ...
    it('dispatches UPDATE_INVENTORYHISTORY actions', async () => {
      const arg = { id: 4261 };
    ...
    it('dispatches PARTIAL_UPDATE_INVENTORYHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVENTORYHISTORY actions', async () => {
      const arg = 42666;
