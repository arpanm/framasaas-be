...
import reducer, {
  ...
  reset,
  updateEntity,
} from './service-order-franchise-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEORDERFRANCHISEASSIGNMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEORDERFRANCHISEASSIGNMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEORDERFRANCHISEASSIGNMENT actions', async () => {
      const arg = { id: 17012 };
    ...
    it('dispatches UPDATE_SERVICEORDERFRANCHISEASSIGNMENT actions', async () => {
      const arg = { id: 17012 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEORDERFRANCHISEASSIGNMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEORDERFRANCHISEASSIGNMENT actions', async () => {
      const arg = 42666;
