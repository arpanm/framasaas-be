...
import reducer, {
  ...
  reset,
  updateEntity,
} from './article-warranty-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTICLEWARRANTYDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTICLEWARRANTYDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTICLEWARRANTYDETAILS actions', async () => {
      const arg = { id: 9916 };
    ...
    it('dispatches UPDATE_ARTICLEWARRANTYDETAILS actions', async () => {
      const arg = { id: 9916 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTICLEWARRANTYDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTICLEWARRANTYDETAILS actions', async () => {
      const arg = 42666;
