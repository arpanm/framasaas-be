...
public class ArticleWarrantyDetailsDocumentTestSamples {
    ...
    public static ArticleWarrantyDetailsDocument getArticleWarrantyDetailsDocumentSample1() {
        return new ArticleWarrantyDetailsDocument().id(1L).documentPath("documentPath1").createddBy("createddBy1").updatedBy("updatedBy1");
    }

    public static ArticleWarrantyDetailsDocument getArticleWarrantyDetailsDocumentSample2() {
        return new ArticleWarrantyDetailsDocument().id(2L).documentPath("documentPath2").createddBy("createddBy2").updatedBy("updatedBy2");
    }
