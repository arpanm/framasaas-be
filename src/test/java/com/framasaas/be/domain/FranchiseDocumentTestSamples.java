...
public class FranchiseDocumentTestSamples {
    ...
    public static FranchiseDocument getFranchiseDocumentSample1() {
        return new FranchiseDocument().id(1L).documentName("documentName1").documentSize(1L).documentPath("documentPath1");
    }

    public static FranchiseDocument getFranchiseDocumentSample2() {
        return new FranchiseDocument().id(2L).documentName("documentName2").documentSize(2L).documentPath("documentPath2");
    }
