...
import static com.framasaas.domain.ArticleWarrantyDetailsDocumentAsserts.*;
...
class ArticleWarrantyDetailsDocumentResourceIT {
    ...
    void partialUpdateArticleWarrantyDetailsDocumentWithPatch() throws Exception {
        ...
        partialUpdatedArticleWarrantyDetailsDocument.validatedTime(UPDATED_VALIDATED_TIME);
